      ...
      <div className="top-services-grid">
        <div className="top-service-col">
          ...
          <p data-aos="slide-right" data-aos-offset="75">
            אנו נהנים ממוניטין של מספר שנים, המבוסס על יסודות כלכליים איתנים
            ...
            החברה פעילה גם בחו"ל, במדינות רומניה וצ'כיה.
          </p>
        </div>
        <div className="top-service-col">
        ...
        <div className="top-service-content-row">
          ...
          <div className="top-service-content-row-text">
            ...
            <p data-aos="slide-up" data-aos-offset="75" style={{ zIndex: -1 }}>
              אנחנו במשפחת ס.א.ד בע"מ מבינים שרכישת דירה היא אחת ההחלטות
              המשמעותית בחייכם. לאורך כל הדרך נלווה אתכם החל מייעוץ מקיף והכוונה
              בתהליך הרכישה, דרך שלבי הבנייה השונים, מסירת מפתח הדירה, וגם אחרי
              הכניסה אליה. כל זאת על מנת שתהיו שקטים ובטוחים בהחלטה שקיבלתם.
            </p>
          </div>
        </div>
      </div>
